...
# space your code out so it's more readable, unless it's something really small or it's a test/example file. on a real program have it readable for other people and yourself later on.
    ...
    # this is still readable. you can't use the short/small format if you have more then one command sometimes e.g. >
    if num > 10:
        print("bigger then 10")
    elif num < 100:
        print("smaller tehn 100")
    elif num is 777:  # num is 777 same as num == 777
        print("Num = 777")
    else:
...
def variable_Comprehension():
    ...
    # same as....
    atHome2 = False
    if atHome2: say = "You're at home"
    else: say = "You're not at home"
    print(say)
...
def number_List():
    ...
    for n, i in enumerate(list): print(n, i)
    ...
    # not the best way >
    for i2 in range(len(list)): print(i2, list[i2])
